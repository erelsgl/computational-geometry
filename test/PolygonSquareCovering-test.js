...
describe('minimal square-covering of ', function() {
	...
	it('L-shapes', function () {
		jsts.minimalSquareCoveringOf([0,0, 10,10, 20,20]).should.eql([ { minx: 0, maxx: 10, miny: 0, maxy: 10 }, { minx: 10, maxx: 20, miny: 10, maxy: 20 }, { minx: 0, maxx: 10, miny: 10, maxy: 20 } ]);
		jsts.minimalSquareCoveringOf([0,0, 15,5, 20,20]).should.eql([ { minx: 0, maxx: 15, miny: 0, maxy: 15 }, { minx: 5, maxx: 20, miny: 5, maxy: 20 }, { minx: 0, maxx: 15, miny: 5, maxy: 20 } ]);
		jsts.minimalSquareCoveringOf([0,0, 5,15, 20,20]).should.eql([ { minx: 0, maxx: 5, miny: 0, maxy: 5 },{ minx: 0, maxx: 5, miny: 5, maxy: 10 },{ minx: 0, maxx: 5, miny: 10, maxy: 15 },{ minx: 15, maxx: 20, miny: 15, maxy: 20 },{ minx: 10, maxx: 15, miny: 15, maxy: 20 },{ minx: 5, maxx: 10, miny: 15, maxy: 20 },{ minx: 0, maxx: 5, miny: 15, maxy: 20 } ]);
		jsts.minimalSquareCoveringOf([10,0, 20,20, 0,10]).should.eql([ { minx: 10, maxx: 20, miny: 0, maxy: 10 },{ minx: 10, maxx: 20, miny: 10, maxy: 20 },{ minx: 0, maxx: 10, miny: 10, maxy: 20 } ]);
	});
});
