...
describe('minimal square-covering of ', function() {
	...
	it('L-shapes', function () { // also tests two types of a 1-knob
		...
		minSquareCoveringTest([10,10, 30,30, 15,25]).should.eql([ { minx: 10, maxx: 25, miny: 10, maxy: 25}, { minx: 15, maxx: 30, miny: 10, maxy: 25}, { minx: 15, maxx: 30, miny: 15, maxy: 30}]); // Fat L-shape, other direction
	...
	it('U-shapes', function() {
		minSquareCoveringTest([0,0, 20,20, 0,11, 2,9]).should.eql([ { minx: 0, maxx: 9, miny: 0, maxy: 9}, { minx: 0, maxx: 9, miny: 11, maxy: 20 },  { minx: 2, maxx: 20, miny: 0, maxy: 18},  { minx: 2, maxx: 20, miny: 2, maxy: 20}]); // Fat U-shape: 3 overlapping squares
	})
	...
	it('floating point numbers D', function() {
		//minSquareCoveringTest([0,1, 1,0.575, 0.7000000000000001,0.275, 0.725,0.185, 0.54,0]).length.should.equal(5)
		// (0, 1),(1, 1),(1, 0.5325),(0.7150000000000001, 0.5325),(0.7150000000000001, 0.2475),(1, 0.2475),(1, 0.20750000000000002),(0.7925, 0.20750000000000002),(0.7925, 0.2475),(1, 0.2475),(1, 0.5325),(0.7150000000000001, 0.5325),(0.7150000000000001, 0.2475),(0.5449999999999999, 0.2475),(0.5449999999999999, 0),(0, 0),(0, 1)
	})
