...
describe('minimal square-covering of ', function() {
	...
	it.skip('floating point numbers D - contains self-intersections!', function() {
		minSquareCoveringTest([0,1, 1,0.5325, 0.7150000000000001,0.2475, 1,0.20750000000000002, 0.7925,0.2475, 1,0.5325, 0.7150000000000001,0.2475, 0.5449999999999999,0]).length.should.equal(5)
	})
