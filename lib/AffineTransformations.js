...
jsts.algorithm.transformAxisParallelRectangle = function(transformation, rect) {
	var newMin = jsts.algorithm.transformedPoint(transformation, {x:rect.minx, y:rect.miny});
	var newMax = jsts.algorithm.transformedPoint(transformation, {x:rect.maxx, y:rect.maxy});
