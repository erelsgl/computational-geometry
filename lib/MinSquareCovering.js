...
var MinSquareCovering = jsts.MinSquareCovering = function(thePolygon) {
...
MinSquareCovering.prototype.calculateConvexityAndVisibility = function() {
...
MinSquareCovering.prototype.isEmpty = function() {
	return this.corners.isEmpty();
}

MinSquareCovering.prototype.findClosestSegment = function(direction, point) {
 ...
 */
MinSquareCovering.prototype.contains = function(point) {
	var intersections = 0;
 ...
 */
MinSquareCovering.prototype.findContinuatorSegment = function() {
 ...
 */
MinSquareCovering.prototype.removeSegments = function(segments, removeCornersBeforeSegments) {
 ...
 */
MinSquareCovering.prototype.removeErasableRegion = function(knob, knobCount) {
	if (!knob.isKnob()) {
		console.dir(knob);
...
MinSquareCovering.prototype.removeAll = function() {
	this.segments.initialize();
	this.corners.initialize();
}

MinSquareCovering.prototype.checkValid = function() {
	this.segments.forEach(function(segment){
...
MinSquareCovering.prototype.findMinimalCovering = function() {
...
jsts.minimalSquareCoveringOf = function(xy) {
	...
	var srpc = new jsts.MinSquareCovering(srp);
