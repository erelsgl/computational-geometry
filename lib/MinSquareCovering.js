	...
	for (;;) {
		if (segment.isKnob()) {
			...
			case 3: 
				...
				//console.log("Aprev: "+Aprev);	console.dir(Aprev)
				//console.log("Dnext: "+Dnext);	console.dir(Dnext)
				var Aprev_sees_Dnext = (Dnext.positiveVisibilitySegment.c1==Aprev);
